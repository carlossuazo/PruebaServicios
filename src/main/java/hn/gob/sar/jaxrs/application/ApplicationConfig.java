 ...
 */
package hn.gob.sar.jaxrs.application;
...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(hn.gob.sar.jaxrs.provider.MyJacksonJsonProvider.class);
        resources.add(hn.gob.sar.jaxrs.resource.MessageResource.class);
        resources.add(hn.gob.sar.jaxrs.resource.PersonResource.class);
